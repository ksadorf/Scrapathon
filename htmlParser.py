...
class Rapport:
	...
	self.id = resReg1.group(3)

	self.head = document("#document_informationsODS h1").html()
	self.rapporteur =re.search('(?:\. M\. )(.+)(?:, rapporteur)',self.head).group(1)
...
url = u"http://www.paris.fr/accueil/Portal.lut?page=webappcontainer&site_id=20&webapp_url=aHR0cDovL2EwNi5hcHBzLnBhcmlzLmZyL2EwNi9qc3Avc2l0ZS9Qb3J0YWwuanNwP3BhZ2U9b2Rz%0ALXNvbHIuZGlzcGxheV9kb2N1bWVudCZpZF9kb2N1bWVudD05NjA4MSZpdGVtc19wZXJfcGFnZT0y%0AMCZzb3J0X25hbWU9JnNvcnRfb3JkZXI9JnRlcm1zPSZxdWVyeT0mZnE9c2VhbmNlX3N0cmluZyUz%0AQUpVSU4lMjAyMDEx"
